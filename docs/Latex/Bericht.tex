...
\begin{itemize}
    ...
    \item \textbf{Eigene Aufnahmen:} Um spezifische Szenarien, die im Kursmaterial unterrepräsentiert waren, gezielt abzudecken, wurden ergänzend eigene Fotoserien angefertigt. Dies betrifft insbesondere Aufnahmen unter schwierigen Lichtverhältnissen oder Winkeln sowie Bilder mit einer hohen Dichte an ablenkenden \textit{Distractors} wie Kassenzetteln, Parktickets und Zeitungen.
...
\begin{itemize}
    ...
    \item \textbf{Hard Negative:} Enthält ein Patch zu mehr als \textbf{20\,\%} einen Distractor (z.\,B. Textblock), wird er gezielt als \textit{hard} negatives Beispiel (\textit{Hard Negative}) gespeichert.
...
% 3. Datensatz Zustand
\textbf{Datengrundlage:}
Die Datengrundlage blieb gegenüber Iteration 2 unverändert. Der Fokus dieser Iteration lag rein auf der Optimierung der Modellarchitektur und der Hyperparameter, um die Leistung auf dem bestehenden Datensatz (ca. 4.000 reale, positive \textit{Patches}, ergänzt durch synthetische Daten) zu maximieren.
